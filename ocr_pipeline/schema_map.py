...
from ocr_pipeline.schema.internship_training_certificate import InternshipCertificate, InternshipCertificateList
...
SCHEMA_MAP: Dict[str, Type[BaseModel]] = {
    ...
    "internship_certificate": InternshipCertificateList,
